...
function MojiPodaci({ prijavljen }) {
  return (
    <>
      <h3 style={{ marginBottom: "50px", marginTop: "100px" }}> VAŠI PODACI </h3>
      <div className='kontejner'>
        ...
        <div className='kartica'>
          ...
          <div> <label> Uloga: </label> <label>{prijavljen.uloga} </label> </div>
          <div> <label> Mejl: </label> <label>{prijavljen.email} </label> </div>
          <div> <label> Korisničko ime: </label> <label>{prijavljen.username} </label> </div>
        </div>
      </div>
    </>
  )
